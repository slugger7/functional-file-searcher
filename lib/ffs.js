...
const filesByExtension = curry((source, extension) => filesByPredicate(isExtension(extension))(source));
const filesByName = curry((source, name) => filesByPredicate(nameContains(name))(source));

const fileByName = curry((source, name) => fileByPredicate(equals(join(source, name)))(source));

const directoriesByName = curry((source, name) => directoriesByPredicate(nameContains(name))(source));

const directoryByName = curry((source, name) => directoryByPredicate(equals(join(source, name)))(source));
